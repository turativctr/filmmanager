...
// Todo TabsContent usa forceMount + oculta via CSS (em vez do unmount padrão do Radix quando a aba
// não está ativa) — o formulário é ÚNICO, envolvendo as 4 abas, e o botão salvar (fora das abas, no
// footer) lê tudo via FormData no submit. Se o conteúdo inativo desmontasse, os campos das outras
// abas simplesmente não existiriam no DOM na hora de salvar.
const TAB_CONTENT_CLASS = "space-y-4 data-[state=inactive]:hidden";
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <Tabs defaultValue="identidade">
            ...
            <TabsContent value="identidade" forceMount className={TAB_CONTENT_CLASS}>
            ...
            <TabsContent value="producao" forceMount className={TAB_CONTENT_CLASS}>
              <div className="space-y-1.5">
                ...
                />
                <p className="text-xs text-muted-foreground">Usado na contagem de refeições do DOOD.</p>
              </div>
              <div className="space-y-1.5">
            ...
            <TabsContent value="documentos" forceMount className={TAB_CONTENT_CLASS}>
              <div className="space-y-3">
                ...
                <label className="flex items-center gap-2 text-sm">
                  <Checkbox
                    checked={continuismoUsarLogo}
                    onCheckedChange={(v) => setContinuismoUsarLogo(Boolean(v))}
                  />
